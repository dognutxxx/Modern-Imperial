...
const Gallery: React.FC<GalleryProps> = ({ lang }) => {
  ...
  const images: GalleryImage[] = [
    ...
    },
    {
      ...
      titleKey: 'Private Imperial Suite',
      category: 'Interior'
    },
    {
      ...
      titleKey: 'Braised Premium Abalone',
      category: 'Dish'
    },
    {
  ...
  return (
    <div id="gallery-section" className="py-24">
      <div className="text-center mb-16">
        <span className="text-accent uppercase tracking-[0.5em] text-[10px] font-black mb-4 block">{t.sub}</span>
        <h2 className="text-5xl font-display text-slate-900 dark:text-white mb-6">{t.title}</h2>
        ...
        {images.map((img, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-primary/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col items-center justify-center p-6 text-center">
              ...
              <h3 className="text-white font-display text-2xl translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-75">{img.titleKey}</h3>
            ...
            <div className="relative bg-white dark:bg-slate-900 overflow-hidden shadow-2xl">
              ...
              <div className="p-8 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center">
                <div>
                  ...
                  <h4 className="text-2xl font-display text-primary dark:text-white">{selectedImage.titleKey}</h4>
                </div>
              </div>
            </div>
          </div>
